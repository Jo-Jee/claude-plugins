## [2026-07-13] init | Wiki initialized
- note: wiki initialization complete

## [2026-07-13] ingest | english-coach Training Mode — Design Spec
- 생성: sources/english-coach-training-mode-design.md,entities/english-coach.md,entities/emma.md,concepts/training-mode-session-lifecycle.md,concepts/english-coach-memory-model.md
